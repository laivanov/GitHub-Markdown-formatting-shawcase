...
> To get started with [Terraform]([url](https://developer.hashicorp.com/terraform/tutorials/cli)), it's important to understand some key terminology and concepts. Here are some fundamental terms and explanations.
